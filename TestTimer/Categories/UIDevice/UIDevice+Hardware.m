...
- (NSString *)modelNameForModelIdentifier:(NSString *)modelIdentifier
{
    ...
    if ([modelIdentifier isEqualToString:@"iPad7,1"])      return @"iPad Pro (12.9-inch, 2nd generation)";
    if ([modelIdentifier isEqualToString:@"iPad7,2"])      return @"iPad Pro (12.9-inch, 2nd generation)";
    if ([modelIdentifier isEqualToString:@"iPad7,3"])      return @"iPad Pro (10.5-inch)";
    if ([modelIdentifier isEqualToString:@"iPad7,4"])      return @"iPad Pro (10.5-inch)";
